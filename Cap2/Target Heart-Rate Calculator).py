...
frequência_máxima = 220 - idade
faixa_frequência50ppc = frequência_máxima * 0.5
faixa_frequência80ppc = frequência_máxima * 0.85
print(f"A frequência cardíaca máxima é de {frequência_máxima}")
print(f"A faixa de frequência cardíaca é entre {faixa_frequência50ppc:.2f} - {faixa_frequência80ppc:.2f}")
